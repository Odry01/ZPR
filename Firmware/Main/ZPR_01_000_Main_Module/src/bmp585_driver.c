...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the BMP585_DRIVER_Initialize function.
...
/*******************************************************************************
  ...
  Remarks:
    See prototype in bmp585_driver.h.
 */
    ...
    switch ( bmp585_driverData.state )
    {
        ...
        case BMP585_DRIVER_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                bmp585_driverData.state = BMP585_DRIVER_STATE_SERVICE_TASKS;
            }
            break;
        }

        case BMP585_DRIVER_STATE_SERVICE_TASKS:
        {
